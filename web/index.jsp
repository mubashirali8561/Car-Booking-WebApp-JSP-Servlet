  ...
  <%@include file="includes/nav.jsp" %>
        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center justify-content-center">
          <div class="col-lg-8 ftco-animate">
          	<div class="text w-100 text-center mb-md-5 pb-md-5">
	            ...
	            <p style="font-size: 18px;">Easy To Book, Easy To Return</p>
    			...
    			<div class="col-md-12	featured-top">
    				<div class="row no-gutters">
	  					<div class="col-md-4 d-flex align-items-center">
	  						<form action="login.jsp" class="request-form ftco-animate bg-primary">
      ...
      <div class="container">
        ...
        <div class="row d-flex">
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="car-single.jsp?id=<%= c.getCarid() %>" class="block-20" style="width:100%; background-image: url(images/<%= c.getCarimg() %>);">
              </a>
              <div class="text pt-4">
              	<div class="meta mb-3">
                  <div><a href="car-single.jsp?id=<%= c.getCarid() %>"><%= c.getTitle() %></a></div>
                  <div><a href="car-single.jsp?id=<%= c.getCarid() %>"></a>&euro;<%= c.getRent() %> <span>/Hour</span></div>
                  <div><a href="car-single.jsp?id=<%= c.getCarid() %>" class="meta-chat"><%= c.getFuel()%></a></div>
                </div>
                <h3 class="heading mt-2"><%= c.getDiscription()%></h3>
                <p><a href="car-single.jsp?id=<%= c.getCarid() %>" class="btn btn-primary">More Detail</a></p>
              </div>
            </div>
          </div>
            <% } %>
    ...
    <section class="ftco-section ftco-about">
		...
		<section class="ftco-section ftco-intro" style="background-image: url(images/bg_3.jpg);">
            ...
            <h2 class="mb-3">Do You Want To Get Our Service? So Don't Be Late.</h2>
